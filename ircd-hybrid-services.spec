# TODO:
# - files in /usr MUST NOT be %config
...
Source0:	http://dl.sourceforge.net/hybserv-bg/%{realname}-%{version}.tgz
...
Hybserver-bg to wielce ulepszona wersja popularnych usług dla IRC-a
...
%dir %{_libdir}/hybserv/tools
%attr(755,root,root) %{_libdir}/hybserv/tools/*
%dir %{_libdir}/hybserv/help
%{_libdir}/hybserv/help/*
%attr(754,root,root) %{_sbindir}/*
%dir %{_sysconfdir}/hybserv
%{_sysconfdir}/hybserv/*
